...
- When implementation needs a UI/product decision, make only a lightweight prototype plan, build an isolated prototype, obtain user approval, then finalize the production implementation and test plan. Do not add UI behavior or product scope the user did not ask for.
