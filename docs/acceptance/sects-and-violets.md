...
- [x] `SET-01` [setup-fang-gu-plus-outsider.json](../../fixtures/acceptance/sects-and-violets/setup-fang-gu-plus-outsider.json)
...
- [x] `SET-02` [setup-vigormortis-no-outsider.json](../../fixtures/acceptance/sects-and-violets/setup-vigormortis-no-outsider.json)
...
- [x] `MAD-01` [cerenovus-madness-assignment.json](../../fixtures/acceptance/sects-and-violets/cerenovus-madness-assignment.json)
...
- [x] `CHG-01` [snake-charmer-vigormortis-swap.json](../../fixtures/acceptance/sects-and-violets/snake-charmer-vigormortis-swap.json)
...
- [x] `IMP-01` [overlapping-no-dashii-sweetheart.json](../../fixtures/acceptance/sects-and-violets/overlapping-no-dashii-sweetheart.json)
...
- [x] `INF-01` [vortox-mathematician-false-number.json](../../fixtures/acceptance/sects-and-violets/vortox-mathematician-false-number.json)
...
- [x] `ORD-01` [sweetheart-barber-follow-up-order.json](../../fixtures/acceptance/sects-and-violets/sweetheart-barber-follow-up-order.json)
...
- [x] `DEM-01` [fang-gu-first-outsider-jump.json](../../fixtures/acceptance/sects-and-violets/fang-gu-first-outsider-jump.json)
...
- [x] `DEM-02` [vigormortis-kills-minion.json](../../fixtures/acceptance/sects-and-violets/vigormortis-kills-minion.json)
...
- [x] `PHI-01` [philosopher-mathematician-duplicate.json](../../fixtures/acceptance/sects-and-violets/philosopher-mathematician-duplicate.json)
...
- [x] `WIN-01` [vortox-no-execution-win.json](../../fixtures/acceptance/sects-and-violets/vortox-no-execution-win.json)
...
- [x] `PST-01` 행동 확정 직후 `export JSON`하고 같은 파일을 import하면 플레이어 정체·진영·생사,
  취함·중독 출처, 능력 인스턴스, 자동 토큰, 미완료 역할 공개와 후속 처리가 동일하다.
- [x] `PST-02` 최근 행동 Undo 후 새로고침해도 Undo된 상태가 자동 저장되어 다시 나타난다.
- [x] `PST-03` 잘못된 JSON import와 현재 게임 교체 취소는 현재 게임과 이벤트 로그를 변경하지 않는다.
- [x] `PST-04` S&V 저장이 존재해도 Trouble Brewing을 열었을 때 해당 게임으로 잘못 복원되지 않는다.
...
- [x] `IPAD-01` 마도서와 현재 행동 영역이 동시에 읽히며 현재 대상과 확정 버튼이 화면 밖으로
  잘리지 않는다.
- [x] `IPAD-02` 역할 공개·집착 공개 중 Storyteller 조작 정보, 감사 근거와 다음 후속 대상이
  플레이어 화면에 노출되지 않는다.
- [x] `IPAD-03` 회전, Safari 뒤로가기, 탭 전환 후에도 현재 단계와 선택 초안이 잘못 확정되지 않는다.
- [x] `IPAD-04` Undo, export와 import 버튼을 터치로 사용할 수 있고 확인 창의 취소·확정이 명확히
  구분된다.
