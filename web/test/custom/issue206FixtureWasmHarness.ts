...
import { initSync } from "../../.codex-tmp/custom-fixture-wasm/clocktower_custom_wasm.js";
import { wasmCoreAdapter } from "../../src/custom/core/wasmClient.js";
import type { Command, GameFile, Proposal, ReplayState } from "../../src/custom/core/types.js";
...
export function issue206FixtureWasmCore() {
  if (!initialized) {
    const bytes = Uint8Array.from(readFileSync(resolve(
      process.cwd(),
      ".codex-tmp/custom-fixture-wasm/clocktower_custom_wasm_bg.wasm",
    )));
