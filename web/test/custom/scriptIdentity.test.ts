...
import type { CustomScriptDefinition, GameFile, ReplayState, ScriptReference } from "../../src/custom/core/types.js";
...
test("custom resume requires the current runtime definition to equal the immutable game snapshot", () => {
  ...
  equal(customGameCanResumeWithDefinition(official as unknown as GameFile, definition), false);
});
