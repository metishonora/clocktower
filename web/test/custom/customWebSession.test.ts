...
} from "../../src/custom/storage/sessionStorage.js";
import type { CustomScriptDefinition, GameEvent, GameFile } from "../../src/custom/core/types.js";
...
test("custom session storage rejects wrong identities without affecting official sessions", async () => {
  ...
  await putRaw(idb, "session:troubleBrewing", official);
  ...
  deepEqual(await readRaw(idb, "session:troubleBrewing"), official);
