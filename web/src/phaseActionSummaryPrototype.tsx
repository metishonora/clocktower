...
const scenarios: SummaryScenario[] = [
  ...
  },
  {
    ...
    parts: [
      { label: "행동자", value: "8번 유나(세탁부 능력, 실제 주정뱅이)" },
      { label: "대상", value: "2번 준호(요리사), 3번 서연(초공감자)" },
  ...
  },
  {
    ...
    proposed: "5번 지우(독살범) → 2번 준호(요리사) · 중독 적용",
    parts: [
      { label: "행동자", value: "5번 지우(독살범)" },
  ...
  },
  {
    ...
    parts: [
      { label: "행동자", value: "8번 유나(수도사 능력, 실제 주정뱅이)" },
