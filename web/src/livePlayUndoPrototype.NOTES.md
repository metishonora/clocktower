...
This development-only prototype compared two placements for `Undo`.
...
Approved production decision (2026-07-16):

- placement: Variant B, attached to the newest event/event-log surface;
- action: `Undo`;
