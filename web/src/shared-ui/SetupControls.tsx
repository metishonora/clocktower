...
export function SetupRoleDetail({ identity, adjustment, choices, disabled, onConfirm, confirmed=false, className = '',appearance='snv' }: { appearance?:'snv'|'bmr';confirmed?:boolean; className?: string; identity: ReactNode; adjustment?:ReactNode; choices?:ReactNode; disabled: boolean; onConfirm: () => void }) {
