# Issue #65 mobile panel prototype

This development-only surface compares two interactions on the same representative live-play screen:

- A: continuous pointer dragging with provisional 20%, 50%, and 85% viewport-height snaps.
- B: a centered, neutral chevron tab that toggles between provisional 20% Grimoire-focused and 85% control-focused heights.
